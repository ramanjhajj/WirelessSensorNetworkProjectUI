...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                // load the data
                var chartData = AmCharts.loadJSON('pressure_data.php?node=6');
                  ...
                  graph1.valueField = "sensirion_press";
                  graph1.bullet = "round";
  ...
  <div class="navbar-inner">
	...
	<li  class="active"><a href="eAtmosPressure.php">Pressure</a></li>
    ...
    <body style="margin-top: 80px; background-color: #e5e5e5">
        ...
        ?>
        <div class="container">
            <h2 class="span9">Pressure Details</h2>
                ...
                <table class="table">
                    ...
                    <?php
                        ...
                        if ( !$link ) {
                                ...
                                // Fetch the data
                                $query = "SELECT sensirion_press, submission_datetime FROM node_data WHERE node_id = 6 ORDER BY submission_datetime ASC";
                                ...
                                while ( $row = mysql_fetch_assoc( $result ) ) {
                                  ...
                                  echo "<td style='text-align: center;'>" . substr($row['sensirion_press'],0,5) . "</td>";
                                  echo "</tr>";
                                }
