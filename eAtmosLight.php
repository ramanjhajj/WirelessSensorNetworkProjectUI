...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                // load the data
                var chartData = AmCharts.loadJSON('light_data.php?node=6');
                  ...
                  graph1.valueField = "visible_light";
                  graph1.bullet = "round";
  ...
  <div class="navbar-inner">
	...
	<p class="navbar-text pull-right">
        ...
        <li><a href="eAtmos.php">Temperature</a></li> 
	<li><a href="eAtmosPressure.php">Pressure</a></li>
	
    	<li class="active"><a href="eAtmosLight.php">Visible Light</a></li> 
        </ul>
      </div>
    </div>
  </div>
    ...
    <body style="margin-top: 80px; background-color: #e5e5e5">
        ...
        ?>
        <div class="container">
            <h2 class="span9">Visible Light Details</h2>
            ...
            <div class="block">
                ...
                <table class="table">
                    <tr>
                        ...
                        <th style='text-align: center;'>Visible Light</th>
                    </tr>
                    <?php
                        ...
                        if ( !$link ) {
                                ...
                                // Fetch the data
                                $query = "SELECT visible_light, submission_datetime FROM node_data WHERE node_id = 6 ORDER BY submission_datetime ASC";
                                ...
                                while ( $row = mysql_fetch_assoc( $result ) ) {
                                  ...
                                  echo "<td style='text-align: center;'>" . substr($row['visible_light'],0,5) . "</td>";
                                  echo "</tr>";
                                }
